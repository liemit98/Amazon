...
function validateResetPass1()                                    
{ 
    var username = document.getElementById("username")            
    var mail = document.getElementById("mail")
    var password = document.getElementById("password")
	var password1 = document.getElementById("password-repeat")
    if(username.value == ""){
   ...
   if(mail.value.length > 50){
    window.alert("Mail không được quá 50 ký tự"); 
    mail.focus(); 
    return false; 
   }
...
function validateResetPass2()                                    
{ 
    var username = document.getElementById("username")            
    var mail = document.getElementById("mail")
    var password2 = document.getElementById("password-old")
   ...
   if(username.value.length > 50){
    ...
    if(password2.value == ""){
        window.alert("Password cũ không được để trống"); 
        password.focus(); 
        return false; 
   }
   
    if (!password2.value.match(patternPassword))                        
    { 
        window.alert("Nhập sai định dạng Password cũ"); 
        password.focus(); 
        return false; 
    }

   if(password.value == ""){
        window.alert("Password mới không được để trống"); 
        password.focus(); 
        return false; 
   }
    ...
    if (!password.value.match(patternPassword))                        
    { 
        window.alert("Nhập sai định dạng Password mới"); 
        password.focus(); 
        return false; 
    } 
